...
if __name__ == "__main__":
    ...
    panel, damage, artifact_main, artifact_sub_num = compute(character_info_path, weapon_info_path, artifact_info_path, enemy_info_path, [], [])
    show_result("single person", detail, args.weapon, args.artifact, panel, damage, artifact_main, artifact_sub_num)
    
    panel, damage, artifact_main, artifact_sub_num = compute(character_info_path, weapon_info_path, artifact_info_path, enemy_info_path, teammate_info_paths, buff_info_paths)
